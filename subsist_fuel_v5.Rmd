...
Since only the response variable was log-transformed, we can exponentiate each  coefficient subtract 1 and multiply by 100 to get the response of every one-unit increase in the independent variable. 
```{r}
