...
car::qqPlot(hh_data2$an_gal_total)
qqPlot(hh_data2$an_gal_total, "lnorm")
...
#Model3, an even simpler model without vehicle stock
...
The simpler model without the community-specific price variable is better in predicting gasoline consumption.
...
An even simpler model that eliminates the vehicle stock, turns out to be less predictive compared to the model that accounts for vehicle stock.  
